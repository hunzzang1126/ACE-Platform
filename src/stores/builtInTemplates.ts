...
const t1Elements: DesignElement[] = [
    ...
    textEl('t1-headline', 'Headline', 20, 30, 260, 60, {
        content: 'THE FUTURE\nIS HERE', fontSize: 28, fontWeight: 800,
        color: '#ffffff', zIndex: 2, role: 'headline',
    }),
    textEl('t1-body', 'Body', 20, 110, 200, 40, {
        content: 'Experience the next generation of creative tools.',
        fontSize: 12, fontWeight: 400, color: '#94a3b8', zIndex: 2, role: 'body',
    }),
    btnEl('t1-cta', 'CTA', 20, 185, 120, 38, {
        label: 'Learn More', fontSize: 12, color: '#ffffff',
...
const t2Elements: DesignElement[] = [
    ...
    textEl('t2-headline', 'Headline', 30, 15, 400, 30, {
        content: 'SUMMER COLLECTION', fontSize: 24, fontWeight: 800,
        color: '#ffffff', fontFamily: 'Inter', zIndex: 2, role: 'headline',
    }),
    textEl('t2-body', 'Subline', 30, 50, 350, 20, {
        content: 'Up to 50% off · Limited time only', fontSize: 13, fontWeight: 500,
        color: 'rgba(255,255,255,0.85)', zIndex: 2, role: 'body',
    }),
    btnEl('t2-cta', 'CTA', 600, 25, 100, 40, {
        label: 'Shop Now', fontSize: 13, color: '#ff6b35',
...
const t3Elements: DesignElement[] = [
    ...
    textEl('t3-headline', 'Headline', 24, 40, 252, 44, {
        content: 'Simplify your\nworkflow', fontSize: 22, fontWeight: 700,
        color: '#1e293b', zIndex: 2, role: 'headline',
    }),
    textEl('t3-body', 'Body', 24, 100, 252, 50, {
        content: 'Automate repetitive tasks and focus on what matters. Trusted by 10,000+ teams.',
        fontSize: 11, fontWeight: 400, color: '#64748b', zIndex: 2, role: 'body',
    }),
    btnEl('t3-cta', 'CTA', 24, 175, 130, 36, {
        label: 'Start Free Trial', fontSize: 11, color: '#ffffff',
        backgroundColor: '#2563eb', borderRadius: 6, zIndex: 3, role: 'cta',
    }),
    textEl('t3-badge', 'Badge', 170, 182, 100, 20, {
        content: 'No credit card required', fontSize: 9, fontWeight: 500,
...
const t4Elements: DesignElement[] = [
    ...
    textEl('t4-headline', 'Headline', 36, 60, 110, 100, {
        content: 'ELEVATE\nYOUR\nPORTFOLIO', fontSize: 20, fontWeight: 700,
        color: '#c9a84c', fontFamily: 'Inter', zIndex: 2, role: 'headline',
    }),
    shapeEl('t4-divider', 'Divider', 36, 180, 40, 1, {
        fill: '#c9a84c', zIndex: 1,
    }),
    textEl('t4-body', 'Body', 36, 200, 110, 80, {
        content: 'Premium wealth management for discerning investors.',
        fontSize: 11, fontWeight: 400, color: '#888888', zIndex: 2, role: 'body',
    }),
    btnEl('t4-cta', 'CTA', 36, 500, 100, 34, {
        label: 'Inquire', fontSize: 11, color: '#0c0c0c',
...
const t5Elements: DesignElement[] = [
    ...
    textEl('t5-headline', 'Headline', 80, 380, 920, 120, {
        content: 'DESIGN\nSUMMIT', fontSize: 80, fontWeight: 900,
        color: '#ffffff', textAlign: 'left', zIndex: 3, role: 'headline',
    }),
    textEl('t5-subline', 'Subline', 80, 530, 600, 30, {
        content: 'Where creativity meets technology', fontSize: 18, fontWeight: 400,
        color: '#a78bfa', zIndex: 3, role: 'body',
    }),
    shapeEl('t5-line', 'Accent Line', 80, 580, 60, 3, {
        fill: '#7c3aed', zIndex: 2, role: 'accent',
    }),
    textEl('t5-location', 'Location', 80, 600, 500, 20, {
        content: 'San Francisco · Moscone Center', fontSize: 13, fontWeight: 500,
        color: '#94a3b8', zIndex: 3,
    }),
    btnEl('t5-cta', 'CTA', 80, 900, 220, 50, {
        label: 'Get Tickets', fontSize: 16, color: '#ffffff',
