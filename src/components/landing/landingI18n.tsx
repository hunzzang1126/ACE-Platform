...
const EN = {
    ...
    heroBadge: 'AI-Native Creative Engine',
    heroTitle1: 'Create at the', heroTitle2: 'Speed of Thought',
    heroSub: 'The creative engine for performance marketing teams. Design, animate, and deploy across every channel.',
...
const translations: Record<LandingLang, LangMap> = {
    ...
    ko: {
        ...
        heroBadge: 'AI 네이티브 크리에이티브 엔진',
        heroTitle1: '생각의', heroTitle2: '속도로 만들다',
        heroSub: '퍼포먼스 마케팅 팀을 위한 크리에이티브 엔진. 디자인, 애니메이션, 모든 채널에 배포하세요.',
    ...
    ja: {
        ...
        heroBadge: 'AIネイティブ クリエイティブエンジン',
        heroTitle1: '思考の', heroTitle2: 'スピードで創る',
        heroSub: 'パフォーマンスマーケティングチームのためのクリエイティブエンジン。デザイン、アニメーション、全チャネルへデプロイ。',
    ...
    zh: {
        ...
        heroBadge: 'AI原生创意引擎',
        heroTitle1: '以思维的', heroTitle2: '速度创造',
        heroSub: '为效果营销团队打造的创意引擎。设计、动画、部署到每个渠道。',
    ...
    es: {
        ...
        heroBadge: 'Motor Creativo con IA Nativa',
        heroTitle1: 'Crea a la', heroTitle2: 'Velocidad del Pensamiento',
        heroSub: 'El motor creativo para equipos de marketing de rendimiento. Diseña, anima y despliega en cada canal.',
    ...
    fr: {
        ...
        heroBadge: 'Moteur Créatif IA Natif',
        heroTitle1: 'Créez à la', heroTitle2: 'Vitesse de la Pensée',
        heroSub: 'Le moteur créatif pour les équipes marketing. Concevez, animez et déployez sur chaque canal.',
    ...
    de: {
        ...
        heroBadge: 'KI-native Kreativ-Engine',
        heroTitle1: 'Erstelle in', heroTitle2: 'Gedankengeschwindigkeit',
        heroSub: 'Die Kreativ-Engine für Performance-Marketing-Teams. Designen, animieren und auf jedem Kanal deployen.',
    ...
    pt: {
        ...
        heroBadge: 'Motor Criativo com IA Nativa',
        heroTitle1: 'Crie na', heroTitle2: 'Velocidade do Pensamento',
        heroSub: 'O motor criativo para equipes de marketing de performance. Design, anime e publique em cada canal.',
    ...
    it: {
        ...
        heroBadge: 'Motore Creativo con IA Nativa',
        heroTitle1: 'Crea alla', heroTitle2: 'Velocità del Pensiero',
        heroSub: 'Il motore creativo per i team di performance marketing. Progetta, anima e distribuisci su ogni canale.',
    ...
    th: {
        ...
        heroBadge: 'เอ็นจิ้นครีเอทีฟ AI เนทีฟ',
        heroTitle1: 'สร้างด้วย', heroTitle2: 'ความเร็วแห่งความคิด',
        heroSub: 'เอ็นจิ้นครีเอทีฟสำหรับทีมการตลาด ออกแบบ อนิเมชัน และเผยแพร่ในทุกช่องทาง',
