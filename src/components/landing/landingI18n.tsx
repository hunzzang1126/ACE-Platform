...
const EN = {
    ...
    heroBadge: 'AI Ad Creative Platform',
    heroTitle1: 'AI Designs It.', heroTitle2: 'Smart Sizing Scales It.',
    heroSub: 'Create ad creatives in seconds with AI, then instantly resize to 50+ formats. Display, social, video — done.',
...
const translations: Record<LandingLang, LangMap> = {
    ...
    ko: {
        ...
        heroBadge: 'AI 광고 크리에이티브 플랫폼',
        heroTitle1: 'AI가 디자인하고,', heroTitle2: '스마트 사이징이 확장합니다.',
        heroSub: 'AI로 몇 초 만에 광고 크리에이티브를 제작하고, 50개 이상의 포맷으로 즉시 리사이즈. 디스플레이, 소셜, 비디오 — 끝.',
    ...
    ja: {
        ...
        heroBadge: 'AI広告クリエイティブプラットフォーム',
        heroTitle1: 'AIがデザインし、', heroTitle2: 'スマートサイジングが拡張。',
        heroSub: 'AIで数秒で広告クリエイティブを作成、50以上のフォーマットに即座にリサイズ。ディスプレイ、ソーシャル、動画 — 完了。',
    ...
    zh: {
        ...
        heroBadge: 'AI广告创意平台',
        heroTitle1: 'AI来设计，', heroTitle2: '智能尺寸来扩展。',
        heroSub: '用AI在几秒内创建广告创意，即刻调整为50+格式。展示、社交、视频 — 搞定。',
    ...
    es: {
        ...
        heroBadge: 'Plataforma de Creativos Publicitarios con IA',
        heroTitle1: 'La IA lo diseña.', heroTitle2: 'Smart Sizing lo escala.',
        heroSub: 'Crea creativos publicitarios en segundos con IA, luego redimensiona a 50+ formatos al instante. Display, social, video — listo.',
    ...
    fr: {
        ...
        heroBadge: 'Plateforme de Créatifs Publicitaires IA',
        heroTitle1: "L'IA conçoit.", heroTitle2: 'Le Smart Sizing adapte.',
        heroSub: 'Créez des visuels publicitaires en secondes avec l\'IA, puis redimensionnez à 50+ formats instantanément. Display, social, vidéo — terminé.',
    ...
    de: {
        ...
        heroBadge: 'AI-Werbecreative-Plattform',
        heroTitle1: 'KI designt es.', heroTitle2: 'Smart Sizing skaliert es.',
        heroSub: 'Erstelle Werbecreatives in Sekunden mit KI, dann sofort auf 50+ Formate skalieren. Display, Social, Video — erledigt.',
    ...
    pt: {
        ...
        heroBadge: 'Plataforma de Criativos Publicitários com IA',
        heroTitle1: 'A IA projeta.', heroTitle2: 'O Smart Sizing escala.',
        heroSub: 'Crie criativos publicitários em segundos com IA, depois redimensione para 50+ formatos instantaneamente. Display, social, vídeo — pronto.',
    ...
    it: {
        ...
        heroBadge: 'Piattaforma di Creativi Pubblicitari IA',
        heroTitle1: "L'IA progetta.", heroTitle2: 'Lo Smart Sizing scala.',
        heroSub: 'Crea creativi pubblicitari in secondi con l\'IA, poi ridimensiona a 50+ formati istantaneamente. Display, social, video — fatto.',
    ...
    th: {
        ...
        heroBadge: 'แพลตฟอร์มสร้างสรรค์โฆษณา AI',
        heroTitle1: 'AI ออกแบบ', heroTitle2: 'Smart Sizing ขยายขนาด',
        heroSub: 'สร้างครีเอทีฟโฆษณาในไม่กี่วินาทีด้วย AI แล้วปรับขนาดเป็น 50+ รูปแบบทันที ดิสเพลย์ โซเชียล วิดีโอ — เสร็จสิ้น',
