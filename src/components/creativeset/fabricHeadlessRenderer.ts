...
// NOTE: renderVariantToHTML5 (font animation CSS export) moved to
// a separate lazy-loaded module to avoid circular dependency.
// Will be implemented when HTML5 export UI is wired up.
